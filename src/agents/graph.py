...
def build_graph() -> StateGraph:
    ...
    # All three LLM agents → Aider LLM fix (fan-in)
    builder.add_edge("code_quality", "aider_llm_fix")
    builder.add_edge("security_audit", "aider_llm_fix")
    builder.add_edge("performance_analysis", "aider_llm_fix")
